...
current list can be seen by running:
    ...
    electrum-nevacoin-server peers
...
`electrum-nevacoin-server peers` will always return an empty list.
...
composing the IRC nickname to identify your server on #electrum-nevacoin.
